...
# Move money from Fundraiser account to Fundraiser owner Personal account.
class Transaction::InternalTransfer::FundraiserCashOut < Transaction::InternalTransfer
end
