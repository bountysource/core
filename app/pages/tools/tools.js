...
angular.module('app')
  ...
  .controller('ToolsController', function ($scope, $routeParams, $window, $location, $api) {
    $scope.selected_relation = null;

    $scope.github_auth = function() {
            ...
            relation.install_plugin = function() {
              ...
              $api.tracker_plugin_create(relation.project.id, relation.linked_account.id).then(function(new_relation) {
                ...
                if (new_relation.error) {
                  ...
                  $scope.tracker_plugin_alert = { type: "error", message: new_relation.error };
                } else {
