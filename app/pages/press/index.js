...
angular.module('app')
  .config(function ($routeProvider) {
    ...
    $scope.articles = [
      ...
      { date: '7/16/13', source: 'The Wall Street Journal', title: 'Bountysource Raises $1.1 Million for the First Crowdfunding Platform for Open-Source Software Projects', href: 'http://online.wsj.com/article/PR-CO-20130716-905630.html?mod=googlenews_wsj' },
