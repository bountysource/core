  ...
  for_each(
    ...
    function(input_type) {
      define(input_type, function() { 
        ...
        var e = element('input', options, arguments);

        // fake placeholders for FireFox
        if (window.navigator.userAgent.match(/firefox/i)) {
          // replace 'placeholder' with '::moz-placeholder'
          e.setAttribute('::-moz-placeholder', e.getAttribute('placeholder'));
