...
describe('Controller: Signin', function () {
  ...
  var HELPERS = {promise: function (mock_data) {return {then: function (fn) {return fn(mock_data); } }; } };
  var MOCKS = {
		forgot_password: {
	...
	describe('FORGOT PASSWORD', function () {
		it('should request passowrd THROUGH forgot_password', function () {
			var rpr_spy = spyOn(api, 'request_password_reset').andReturn(HELPERS.promise(MOCKS.forgot_password));
			scope.forgot_password();
			expect(rpr_spy).toHaveBeenCalled();
