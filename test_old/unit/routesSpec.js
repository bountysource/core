...
describe('All the wonderful routes we have', function() {
  ...
  describe('Fundraisers', function() {
    ...
    it('should map routes for fundraisers edit', function() {
      inject(function($route) {
    ...
    it('should map routes for just fundraisers', function() {
      inject(function($route) {
        expect($route.routes['/fundraisers'].controller).toBe('FundraiserIndexController');
        expect($route.routes['/fundraisers'].templateUrl).toEqual('app/fundraisers/index.html');
      });
    });

    it('should map routes for a complete fundraisers', function() {
      inject(function($route) {
        expect($route.routes['/fundraisers/completed'].controller).toBe('FundraiserIndexController');
    ...
    it('should map routes for updates to fundraisers', function() {
      inject(function($route) {
