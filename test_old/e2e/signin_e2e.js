...
//  it("should clear cookies at start of test_old", function() {
//    browser().navigateTo('/');
//    //clear cookies at the end of the test_old. Allows refreshing of tests in-browser when singlerun-mode is false
...
//    Mock.pushScenario("/fundraisers/:id", "GET", "success");
//
//    browser().navigateTo('/fundraisers/451-fake-fundraisers/pledge');
...
//    using('form[name=form]').element(".btn:visible").click();
//
//    expect(browser().location().path()).toEqual('/fundraisers/451-fake-fundraisers/pledge');
//    expect(input('pledge.amount').val()).toEqual('200');
