with (scope('Faq', 'App')) {
    ...
    render(
      ...
      section({ id: 'faqs' },
        dl(
          ...
          dt({id: 'faq2'}, "Why should I use BountySource for my project?"),
          dd(
          ...
          dt({id: 'faq3'}, "How does BountySource work?"),
          ...
          dt({id: 'faq4'}, "...so, what's my role in all of this?"),
          ...
          dt({id: 'faq5'}, "Can I work on issues and collect bounties within my own project?"),
          dd("Yes."),
    
          dt({id: 'faq6'}, "Who can collect a bounty?"),
  ...
  route('#faq/developers', function() {
    render(
      ...
      section({ id: 'faq' },
        dl(
          dt({id: 'faq1'}, "How do you know a project committer will accept any pull requests at all?"),
          ...
          dt({id: 'faq6'}, "How do I receive payment?"),
          ...
          dt({id: 'faq7'}, "What does it cost to collect a bounty?"),
          ...
          dt({id: 'faq8'}, "What can I do with my earnings?"),
          dd(
          ...
          dt({id: 'faq9'}, "Do I have to pay taxes on the bounties I collect?"),
          ...
          dt({id: 'faq10'}, "What is your relationship with Github?"),
    ...
    render(
      ...
      section({ id: 'faq' },
        dl(
          ...
          dt({id: 'faq5'}, "What happens after I post a bounty?"),
          ...
          dt({id: 'faq6'}, "What does it cost to post a bounty?"),
          dd("Nothing!"),
        
          dt({id: 'faq7'}, "What if I am unsatisfied with the solution to an issue I've backed?"),
          ...
          dt({id: 'faq8'}, "When will a solution be made available to the public?"),
          ...
          dt({id: 'faq9'}, "What happens if an issue is never closed?"),
          ...
          dt({id: 'faq10'}, "Does 100% of my bounty go to the developer?"),
