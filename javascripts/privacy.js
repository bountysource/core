with (scope('Privacy', 'App')) {
  ...
  route('#privacypolicy', function() {
    render(
      ...
      Columns.side(
        ul({ style: 'position: fixed;', id: 'faq-nav' },
          li(a({ 'class': 'privacy-nav-button active', id: 'nav-sec1',     href: curry(scrollTo, 0, 0) }, '1. Introduction')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec2',    href: curry(scroll_to_marker, location_markers.sec2) },     '2. Information We Collect')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec3', href: curry(scroll_to_marker, location_markers.sec3) },  '3. How We Collect Information About You')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec4', href: curry(scroll_to_marker, location_markers.sec4) },  '4. How We Use the Information We Collect')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec5', href: curry(scroll_to_marker, location_markers.sec5) },  '5. Sharing of Your Information')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec6', href: curry(scroll_to_marker, location_markers.sec6) },  '6. Our Policies Concerning Children')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec7', href: curry(scroll_to_marker, location_markers.sec7) },  '7. How to Access and Update Your Information')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec8', href: curry(scroll_to_marker, location_markers.sec8) },  '8. Your Sharing and Messaging Options')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec9', href: curry(scroll_to_marker, location_markers.sec9) },  '9. International Transfers')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec10', href: curry(scroll_to_marker, location_markers.sec10) },  '10. Privacy Policies of Linked Sites and Advertisers')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec11', href: curry(scroll_to_marker, location_markers.sec11) },  '11. Security of Your Information')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec12', href: curry(scroll_to_marker, location_markers.sec12) },  '12. Changes to Our Privacy Policy')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec13', href: curry(scroll_to_marker, location_markers.sec13) },  '13. Your California Privacy Rights')),
          li(a({ 'class': 'privacy-nav-button', id: 'nav-sec14', href: curry(scroll_to_marker, location_markers.sec14) },  '14. Contact Us'))
        )
      ),

      Columns.main(
        div({ id: 'privacy' },
          h1('Bountysource Privacy Policy'),

          p('Bountysource\'s Privacy Policy is designed to provide clarity about the information we collect and how we use it to provide a better experience. By using our Website or Services or agreeing to our ', a({ target: '_blank', href: 'https://www.bountysource.com/#termsofservice' }, "Terms of Service"),  ' you consent to our collection, storage, use and disclosure of your personal information as described in this Privacy Policy.'),
          
          br,
          
          location_markers.sec1,
          h1('1. Introduction'),
  ...
  define('scroll_listener', function(e) {
    if (is_in_viewport(location_markers.sec2)) {
      set_active_nav_element('nav-sec2');
    } else if (is_in_viewport(location_markers.sec3)) {
      set_active_nav_element('nav-sec3');
    } else if (is_in_viewport(location_markers.sec4)) {
      set_active_nav_element('nav-sec4');
    } else if (is_in_viewport(location_markers.sec5)) {
      set_active_nav_element('nav-sec5');
    } else if (is_in_viewport(location_markers.sec6)) {
      set_active_nav_element('nav-sec6');
    } else if (is_in_viewport(location_markers.sec7)) {
      set_active_nav_element('nav-sec7');
    } else if (is_in_viewport(location_markers.sec8)) {
      set_active_nav_element('nav-sec8');
    } else if (is_in_viewport(location_markers.sec9)) {
      set_active_nav_element('nav-sec9');
    } else if (is_in_viewport(location_markers.sec10)) {
      set_active_nav_element('nav-sec10');
    } else if (is_in_viewport(location_markers.sec11)) {
      set_active_nav_element('nav-sec11');
    } else if (is_in_viewport(location_markers.sec12)) {
      set_active_nav_element('nav-sec12');
    } else if (is_in_viewport(location_markers.sec13)) {
      set_active_nav_element('nav-sec13');
    } else if (is_in_viewport(location_markers.sec14)) {
      set_active_nav_element('nav-sec14');
    } else if (is_in_viewport(location_markers.sec1)) {
      set_active_nav_element('nav-sec1');
    }
  });
  ...
  define('set_active_nav_element', function(id) {
    ...
    var nav_elements = document.getElementsByClassName('privacy-nav-button');
