with (scope('TermsofService', 'App')) {
  ...
  route('#termsofservice', function() {
    render(
      ...
      p('THIS IS A LEGALLY BINDING AGREEMENT between you and BountySource ("', b('BountySource'), '", "', b('we'), '" or "', b('us'), '"). By using the BountySource.com website ("', b('Site'), '") or any of the BountySource services ("', b('Services'), '"), you agree to all the terms and conditions of this Terms of Service ("', b('Agreement'), '"). If you are entering into this Agreement on behalf of a company or other legal entity, you represent that you have the authority to bind such entity to these terms and conditions, in which case the terms "', b('you'), '" or "', b('your'), '" shall refer to such entity. If you do not have such authority, or if you do not agree with these terms and conditions, you must not proceed with the registration process or use our Site or Service.'),
      
      h1('1. Overview'),
      
      p('BountySource is a platform for encouraging development in open-source projects by enabling users to offer cash rewards for solutions to existing development issues.'),
      
      ul(
          li('Any user can define a development issue (“', b('Issue'), '”) by posting an issue/feature/bug on an issue tracking website such as GitHub.com, BitBucket.org or a similar third-party site ("', b('Tracking Site'), '").'),
          li('Any user can post a cash bounty (“', b('Bounty'), '”) on BountySource to encourage development of a successful solution to an Issue posted on a Tracking Site. These users are referred to as "', b('Backers'), '" in this Agreement.'),
          li('Any user can try to develop a solution for an Issue and win the Bounty. These users are referred to as "', b('Developers'), '" in this Agreement.'),
          li('Once Developers finish their solutions to an Issue (“', b('Solutions'), '”), they submit them to the appropriate open-source project\'s code repository ("', b('Repository'), '"). Persons authorized to accept and merge code will decide whether a Solution is accepted or not.  BountySource will pay the Bounty to the Developer of the first Solution accepted.'),
          li('Users that are authorized to merge code into a Repository on behalf of an open-source project are referred to as "', b('Committers'), '" in this Agreement.')
        ),
      ...
      p('2.2 Backers may create more than one Bounty on an Issue. Once a Bounty has been created, Backers may not decrease or cancel it.'),
      p('2.3 Unless otherwise specified, a Solution must be accepted within six months (the “', b('Deadline'), '”).'),
      p('2.4 If no Solution is accepted by the Deadline, Backers will receive 90% of their Bounty back. Bounties are nonrefundable if a Solution is accepted by the Deadline.'),
      ...
      p('2.9 BountySource and its payments partners will remove their fees before transmitting proceeds of a Bounty to Developers or refunding to Backers (if no Solution is accepted by the Deadline).'),
      ...
      p('2.11 BountySource reserves the right to determine the award of a Bounty in cases where Committers accept two Solutions to an Issue simultaneously or in other situations where multiple Developers have a fair and reasonable claim to a Bounty. By participating in our Service, you agree that BountySource’s good faith decisions will be final and not grounds for claims or litigation. BountySource shall not be liable to you, and you hereby release us from any and all claims, for any damages resulting from or in connection with of any such determinations. BountySource’s policy is not to comment on the reasons for any of those actions.'),
      ...
      p('5.1 ', b('Fees.'), ' Joining BountySource is free. However, to offset the costs of running the Service, we retain the interest earned while holding Bounties and a percentage of Bounties.'),
      ...
      p({style: 'padding-left: 30px'}, '8.2.3 if we believe it is necessary to avoid any financial loss or legal liability (whether civil or criminal) on the part of BountySource or any of its related companies and their directors, officers, employees and agents;'),
      p({style: 'padding-left: 30px'}, '8.2.4 in accordance with the practices disclosed in our privacy policy; or'),
      p({style: 'padding-left: 30px'}, '8.2.5 if deemed necessary at our sole discretion to protect the integrity of the Service or protect the rights and property of Bountysource or its officers, directors, employees affiliates or agents, our users and third parties.'),
      ...
      p(i('Effective Date of Revision: October 24, 2012'))
    );
  });
}