with (scope('TermsofService', 'App')) {
  ...
  route('#termsofservice', function() {
    render(
      ...
      ul(
          li('Any user can define a development issue (“', b('Issue'), '”) by posting an issue/feature on GitHub.com or a similar third-party site ("', b('Tracker'), '").'),
          li('Any user can post a cash bounty (“', b('Bounty'), '”) on BountySource to encourage development of a successful solution to an Issue posted on a Tracker. These users are referred to as "', b('Backers'), '" in this Agreement.'),
      ...
      p(i('Effective Date of Revision: October 22, 2012'))
    );
  });
}