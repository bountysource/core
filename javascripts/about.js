with (scope('About', 'App')) {
  ...
  route('#about', function() {
    render(
      ...
      p("However, years went by and little progress was made, while the open-source community continued to evolve. Now, we're back with the same vision - overall improvement in open-source software development - but a completely different system."),
      
      p("Instead of focusing on project hosting - repositories, issue tracking and all - we are concentrating on just the bounty/crowdfunding aspect of BountySource's original idea."),
      
      h1("How does BountySource work?"),
      ...
      p("BountySource stories this bounty (or bounties - other backers are encouraged to create bounties on the same issue) for a maximum of six months. If the issue isn't resolved within this period, the backers are refunded."),
