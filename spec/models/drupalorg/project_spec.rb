...
describe Drupalorg::Project do
  describe "Search" do
    let!(:tracker) { create(:drupalorg_project, url: "https://www.drupal.org/project/commerce") }
    ...
    it "should find issue by URL" do
      ...
      Github::Repository.extract_from_url("https://www.drupal.org/project/commerce/").should be_present
      Github::Repository.extract_from_url("https://www.drupal.org/project/commerce").should be_present
