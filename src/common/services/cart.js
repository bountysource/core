...
angular.module('services').service('$cart', function ($window, ShoppingCartItems) {

  this.items = [];

  this.addItem = function (itemType, amount, currency, attrs) {
    var payload = angular.extend(attrs, {
      item_type: itemType,
      amount: amount,
      currency: currency
    });
    return ShoppingCartItems.create(payload);
  };
